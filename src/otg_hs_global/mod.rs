...
pub struct RegisterBlock {
    ...
    #[doc = "OTG_HS Receive status debug read register\r\n         (peripheral mode mode) OTG_HS Receive status debug read register\r\n         (host mode)"]
    pub otg_hs_grxstsr: OtgHsGrxstsrUnion,
    #[doc = "OTG_HS status read and pop register\r\n         (peripheral mode) OTG_HS status read and pop register(host\r\n          mode)"]
    pub otg_hs_grxstsp: OtgHsGrxstspUnion,
    #[doc = "0x24 - OTG_HS Receive FIFO size register"]
    pub otg_hs_grxfsiz: OTG_HS_GRXFSIZ,
    #[doc = "Endpoint 0 transmit FIFO size(peripheral\r\n          mode) OTG_HS nonperiodic transmit FIFO size\r\n          register(host mode)"]
    pub otg_hs: OtgHsUnion,
